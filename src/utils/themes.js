  ...
  sunset: {
    ...
    modes: {
      pomodoro: {
        ...
        modalBg: 'bg-[#4a1c1c]/95 border-red-400/30 shadow-[0_15px_50px_rgba(186,73,73,0.3)]',
      ...
      shortBreak: {
        ...
        activePill: 'bg-white/20 text-white shadow-sm',
        modalBg: 'bg-[#18393d]/95 border-teal-400/30 shadow-[0_15px_50px_rgba(56,133,138,0.3)]',
      ...
      longBreak: {
        ...
        activePill: 'bg-white/20 text-white shadow-sm',
        modalBg: 'bg-[#173247]/95 border-blue-400/30 shadow-[0_15px_50px_rgba(57,112,151,0.3)]',
  ...
  aurora: {
    ...
    modes: {
      pomodoro: {
        ...
        activePill: 'bg-white/20 text-white shadow-sm',
        modalBg: 'bg-[#1e1b4b]/95 border-indigo-400/30 shadow-[0_15px_50px_rgba(99,102,241,0.35)]',
      ...
      shortBreak: {
        ...
        activePill: 'bg-white/20 text-white shadow-sm',
        modalBg: 'bg-[#0e3b48]/95 border-cyan-400/30 shadow-[0_15px_50px_rgba(8,145,178,0.35)]',
      ...
      longBreak: {
        ...
        activePill: 'bg-white/20 text-white shadow-sm',
        modalBg: 'bg-[#3b176d]/95 border-purple-400/30 shadow-[0_15px_50px_rgba(124,58,237,0.35)]',
  ...
  emerald: {
    ...
    modes: {
      pomodoro: {
        ...
        activePill: 'bg-white/20 text-white shadow-sm',
        modalBg: 'bg-[#06402e]/95 border-emerald-400/30 shadow-[0_15px_50px_rgba(5,150,105,0.35)]',
        notchBg: 'bg-[#043324]/95 border-emerald-400/40 text-emerald-200 hover:border-emerald-300',
      },
      shortBreak: {
        ...
        badge: 'bg-teal-500/20 text-teal-100 border-teal-400/30',
        activePill: 'bg-white/20 text-white shadow-sm',
        modalBg: 'bg-[#0a453f]/95 border-teal-400/30 shadow-[0_15px_50px_rgba(13,148,136,0.35)]',
      ...
      longBreak: {
        ...
        badge: 'bg-blue-500/20 text-blue-100 border-blue-400/30',
        activePill: 'bg-white/20 text-white shadow-sm',
        modalBg: 'bg-[#172e5c]/95 border-blue-400/30 shadow-[0_15px_50px_rgba(30,64,175,0.35)]',
  ...
  obsidian: {
    ...
    modes: {
      pomodoro: {
        ...
        modalBg: 'bg-[#090d16]/95 border-slate-700/60 shadow-[0_15px_50px_rgba(0,0,0,0.7)]',
      ...
      shortBreak: {
        ...
        activePill: 'bg-white/15 text-white shadow-sm',
        modalBg: 'bg-[#0b1c24]/95 border-cyan-800/50 shadow-[0_15px_50px_rgba(0,0,0,0.7)]',
      ...
      longBreak: {
        ...
        activePill: 'bg-white/15 text-white shadow-sm',
        modalBg: 'bg-[#150f22]/95 border-purple-800/50 shadow-[0_15px_50px_rgba(0,0,0,0.7)]',
